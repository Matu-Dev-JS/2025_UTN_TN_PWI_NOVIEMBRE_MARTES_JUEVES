...
//Si el mensaje es vip deberia tener la class='vip' que debe hacer algun cambio visual, por ejemplo el texto resaltado (text-shadow)
...
//renderizar el mensaje dentro de un div
//si el mensaje es vip deveria tener la class='vip' 
//si el mensaje es isPinned deberra tener un texto que diga 'importante'
//hacer el renderizado de los attachments
const mensaje_HTML = document.getElementById("mensaje")
...
mensaje_HTML.innerHTML = `
        ...
        <br>
        <span 
            class='message ${mensaje.isVip ? 'vip' : ''}'
        >
            ${mensaje.text}
        </span>
        <br>
        <div>
            ${renderAttachments(mensaje.attachments)}
        </div>
    `